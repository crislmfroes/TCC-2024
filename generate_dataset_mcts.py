...
for i in tqdm.trange(10):
    ...
    try:
        while not done and counter < 50:
            ...
            observation_generator = outlines.generate.json(mllm, Observation)#, outlines.samplers.greedy())
            ...
            def child_finder(node: Node, montecarlo: MonteCarlo):
                for n in range(n_actions_sampled):
                        ...
                        observation: Observation = observation_generator(observation_prompt)
            ...
            montecarlo.simulate(expansion_count=3)
